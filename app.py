...
def transcribe_stream(url: str, groq_keys_raw: str, language: str = "zh"):
    ...
    try:
        yield sse("log", {"msg": "â³ Getting video URL..."})
        ...
        yield sse("log", {"msg": "ðŸ”Š Extracting audio (ffmpeg)..."})
        ...
        yield sse("log", {"msg": f"âœ… Transcription done! ({result.get('duration', 0):.1f}s audio)"})
